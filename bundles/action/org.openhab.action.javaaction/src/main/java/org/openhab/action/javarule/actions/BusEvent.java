 ...
 */
package org.openhab.action.javarule.actions;
 ...
 * This gives direct write access to the openHAB event bus from within the
 * rules. Items should not be updated directly (through modify clauses), but
 * updates should be sent to the bus, so that all interested bundles are
 * notified.
 * 
 * @author Kai Kreuzer
 * @since 0.7.0
